...
function validation() {
  ...
  var nameErrMsg = document.querySelector("#nameErrMsg");
  var desc = document.querySelector("#desc");
  var descErrMsg = document.querySelector("#descErrMsg");
  var assign = document.querySelector("#assign");
  var assignErrMsg = document.querySelector("#assignErrMsg");
  var dueDate = document.querySelector("#dueDate");
  var dueDateErrMsg = document.querySelector("#dueDateErrMsg");
  var status = document.querySelector("#status");
  var statusErrMsg = document.querySelector("#statusErrMsg");
...
function editvalidation() {
  ...
  var enameErrMsg = document.querySelector("#enameErrMsg");
  var editdesc = document.querySelector("#editdesc");
  var edescErrMsg = document.querySelector("#edescErrMsg");
  var editassign = document.querySelector("#editassign");
  var eassignErrMsg = document.querySelector("#eassignErrMsg");
  var editdueDate = document.querySelector("#editdueDate");
  var edueDateErrMsg = document.querySelector("#edueDateErrMsg");
  var editstatus = document.querySelector("#editstatus");
  var estatusErrMsg = document.querySelector("#estatusErrMsg");
